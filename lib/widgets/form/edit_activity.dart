...
class _EditActivityFormState extends State<EditActivityForm> {
  ...
  late double _amount;
  late List<dynamic> _selectedCategories;
  ...
  void initState() {
    ...
    _isSpend = widget.initialIsSpend;
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Gagal memperbarui data! Error: $e',
